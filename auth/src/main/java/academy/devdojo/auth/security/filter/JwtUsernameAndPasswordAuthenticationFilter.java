...
public class JwtUsernameAndPasswordAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication auth) throws IOException, ServletException {
        ...
        String encryptedToken = encriptToken(signedJWT);

        log.info("Token gnerated successfully, adding it to the response header");
    ...
    private JWTClaimsSet createJWTClaimSet(Authentication auth, ApplicationUser applicationUser){
        log.info("Creating the JwtClaimSet Object fo '{}'", applicationUser);
    ...
    private String encriptToken(SignedJWT signedJWT) throws JOSEException {
        log.info("Starting the cncryptToken method");
